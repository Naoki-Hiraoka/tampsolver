...
bool OsqpEigenSolver::init(const Eigen::SparseMatrix<double>& H,
...
bool OsqpEigenSolver::update(const Eigen::SparseMatrix<double>& H,
                             const Eigen::SparseMatrix<double>& A,
  ...
  solver.updateLinearConstraintsMatrix(H);
