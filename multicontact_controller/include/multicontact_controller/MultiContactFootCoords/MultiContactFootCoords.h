#ifndef MULTICONTACT_FOOTCOORDS_H
#define MULTICONTACT_FOOTCOORDS_H
...
namespace multicontact_controller {
  class ContactPointMCFC: public cnoidbodyutils::ContactPoint {
  public:
    // odom系の座標のref値
  ...
  public:
    ...
    bool calcRootOdometry(cnoid::Body* robot, std::vector<std::shared_ptr<ContactPointMCFC> >& contactPoints);
